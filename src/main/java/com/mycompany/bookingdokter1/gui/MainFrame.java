...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        messages = ResourceBundle.getBundle("i18n.messages", new Locale("id", "ID"));
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Gagal memuat data booking dari database.\nPeriksa koneksi MongoDB.",
                    "Kesalahan Koneksi", JOptionPane.ERROR_MESSAGE);

            // Tetap tampilkan UI meski data tidak bisa dimuat
            initComponents();
            setupLayout();
        }
